    ...
    <div className="max-w-full rounded-lg border border-gray-200 bg-gray-50 p-2 py-[12px] font-inter">
      <div className="mb-2 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <GithubIcon />
          <a href={repo.url} className="text-gray-700 hover:underline break-all">
            {repo.name || repo.url?.replace("https://" || "http://", "")}
          </a>
          <div className="flex items-center gap-1 border rounded-2xl px-2 py-1 text-blue-foreground text-xs bg-blue-background">
      ...
      <section {...getCollapseProps()}>
        ...
        <div className="mb-4 grid grid-cols-3 gap-2 font-normal text-sm leading-5 font-inter">
