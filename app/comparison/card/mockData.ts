    ...
    links: [
      {
        ...
        description: 'This page shows the performance of Lodestar as a validator client, run by ChainSafe infrastructure to support client diversity on mainnet validators via Lido.',
      },
      {
  ...
  metadata: {
    ...
    impactStatement: {
      ...
      statement: [
        ...
        {
          answer: 'OP stack developers would lose access to a powerful and cutting edge symbolic EVM implementation. Development of analysis tooling for the OP stack would become harder. Application developers targeting the OP stack would lose access to tools checking for safety and correctness.',
          question: 'How would it impact the OP Stack if your project ceased to exist?',
        },
      ],
    },
